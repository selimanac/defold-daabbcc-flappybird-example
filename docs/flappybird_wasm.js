...
var wasmImports = {
  ...
  Eh: ___syscall_accept4,
  Dh: ___syscall_bind,
  Ch: ___syscall_connect,
  Bh: ___syscall_dup3,
  f: ___syscall_fcntl64,
  Ah: ___syscall_getpeername,
  zh: ___syscall_getsockname,
  Z: ___syscall_getsockopt,
  yh: ___syscall_ioctl,
  xh: ___syscall_listen,
  wh: ___syscall_mkdirat,
  Y: ___syscall_openat,
  vh: ___syscall_poll,
  uh: ___syscall_readlinkat,
  th: ___syscall_recvfrom,
  sh: ___syscall_renameat,
  rh: ___syscall_rmdir,
  qh: ___syscall_sendto,
  sa: ___syscall_socket,
  ph: ___syscall_stat64,
  X: ___syscall_unlinkat,
  mh: __emscripten_get_now_is_monotonic,
  lh: __emscripten_lookup_name,
  kh: __emscripten_system,
  jh: __emscripten_throw_longjmp,
  ya: __gmtime_js,
  xa: __localtime_js,
  wa: __mktime_js,
  ih: __tzset_js,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Gh"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Hh"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Ih"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Jh"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["Kh"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["Mh"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["Nh"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["Oh"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["Ph"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["Qh"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["Rh"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["Sh"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["Th"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["Uh"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["Vh"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["Wh"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["Xh"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["Yh"])(a0, a1);
};
